  ...
  return (
    <div className="mb-4 relative flex justify-center items-center">
      <input
        ...
        value={value}
        onChange={onChange}
        className="min-h-[auto] rounded-md shadow-md border bg-transparent px-3 py-2 placeholder:text-neutral-500 outline-none transition-all duration-200 ease-linear dark:text-neutral-200 dark:placeholder:text-neutral-200 w-full"
